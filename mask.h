/*
    Trabalho 2 de Organização de Computadores Digitais I (SCC0610)

    Equipe 8 - Projeto Brisa

    Alunos: Felipe Tetzner                  NºUSP:  9897870
            Thales de Lima Kobosighawa              9897884
            Thiago Lima e Silva Rissotto            9896641
...
#define separa_cfuncao		0x0000000f	// 000000 00000 00000 00000 00000 111111  usada com &
...
// Cada estado é representado por um dos estados da Máquina de Estados Finitos. Representam os bits de controle(SC).
#define estado0 0b1001010000001000          // Busca de instrução.
#define estado1 0b0000000000011000          // Busca dos registradores/decodificação da instrução.
#define estado2 0b0000000000010100          // Cálculo do endereço de memória.
#define estado3 0b0001100000000000          // Acesso à memória.
#define estado4 0b0100000000000010          // Etapa de conclusão da leitura de memória.
#define estado5 0b0010100000000000          // Acesso à memória.
#define estado6 0b0000000001000100          // Execução.
#define estado7 0b0000000000000011          // Conclusão de tipo R.
#define estado8 0b0000001010100100          // Conclusão do Branch.
#define estado9 0b0000010100000000          // Conclusão do Jump.

// Máscaras utilizadas para comparação do campo de função de cada instrução.
#define funct_add       0x00000000
#define funct_subtract  0x00000002
#define funct_and       0x00000004
#define funct_or        0x00000005
#define funct_slt       0x0000000a

// Máscaras utilizadas para comparação do campo de opcode de cada instrução.
#define lw      0b10001100000000000000000000000000
#define tipoR   0b00000000000000000000000000000000
#define beq     0b00010000000000000000000000000000
#define sw      0b10101100000000000000000000000000
#define jump    0b00001000000000000000000000000000
